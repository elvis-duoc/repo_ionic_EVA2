  ...
  public getProfileData() {
    ...
    switch (providerData.providerId) {
      case 'facebook.com':
        ...
        break;
      case 'password':
        userModel.image = 'https://static.vecteezy.com/system/resources/previews/002/275/847/non_2x/male-avatar-profile-icon-of-smiling-caucasian-man-vector.jpg';
        break;
      case 'twitter.com':
    ...
    userModel.name = providerData.name || providerData.displayName || 'Registra tu Asistencia';
    userModel.role = 'How would you describe yourself?';
    userModel.description = providerData.description || 'Presiona el botón azul y escanea el código QR que tu docente proyectará en clases.';
